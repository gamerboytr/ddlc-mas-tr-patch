...
translate Turkish mas_fun_fact_struck_by_lightning_72fd0568:
...
translate Turkish mas_fun_fact_struck_by_lightning_1b97952d:
...
translate Turkish mas_fun_fact_mental_word_processing_06608acb:

    m 1tku "Our brains process information very rapidly and love predictability in in our language."

translate Turkish mas_fun_fact_mental_word_processing_01503d71:
...
translate Turkish mas_fun_fact_mental_word_processing_fbe6360d:

    m 1tfu "..."

translate Turkish mas_fun_fact_mental_word_processing_da5be9c0:

    m 2hfu "Check the history log if you missed them~"

translate Turkish mas_fun_fact_I_am_e0329b3c:

    m 1hua "Mmmm, I love language facts!"

translate Turkish mas_fun_fact_I_am_94697ab3:

    m 3eub "In English, the shortest complete sentence is 'I am.'"

translate Turkish mas_fun_fact_I_am_2ecfe1c0:

    m 1eua "Here's an example."

translate Turkish mas_fun_fact_I_am_4bd3a339:

    m 2rfb "'{i}Monika! Who's [player]'s loving girlfriend?{/i}'"

translate Turkish mas_fun_fact_I_am_7debc54b:

    m 3hub "'I am!'"

translate Turkish mas_fun_fact_I_am_d81c1322:

    m 1hubsa "Ehehe~"

translate Turkish mas_fun_fact_low_rates_80d95bb5:

    m 1hua "Now this is a wholesome one..."

translate Turkish mas_fun_fact_low_rates_99687c5e:

    m 1eua "Currently, we have the lowest crime rates, maternity death, infant mortality and illiteracy ever in human history."

translate Turkish mas_fun_fact_low_rates_128d433c:

    m 3eub "Life expectancy, average income, and standards of living is the highest for most of the global population too!"

translate Turkish mas_fun_fact_low_rates_9e722f66:
...
translate Turkish mas_fun_fact_low_rates_3f6a56bc:

    m 1hua "There really is {i}hope{/i}..."

translate Turkish mas_fun_fact_desert_76ef7536:

    m 3euc "Deserts have a pretty unique ecosystem..."

translate Turkish mas_fun_fact_desert_d045976c:

    m 3rksdla "However, they don't offer a lot of positive factors for humans."

translate Turkish mas_fun_fact_desert_f44e211b:
...
translate Turkish mas_fun_fact_getting_older_4dac0c21:

    m 1eka "So I'll always cherish our moments together, no matter how long or short they are."

translate Turkish mas_fun_fact_getting_older_ec01fa2b:

    m 1lkbsa "Although sometimes it feels like time stops when I'm with you."

translate Turkish mas_fun_fact_getting_older_118b8306:

    m 1ekbfa "Do you feel the same, [player]?"

translate Turkish mas_fun_fact_getting_older_58cee739:

    m 1hubfb "Ahaha, I thought so!"

translate Turkish mas_fun_fact_dancing_plague_eb91ccb6:

    m 3esa "Oh, this one's pretty weird..."

translate Turkish mas_fun_fact_dancing_plague_f086edd7:

    m 1eua "Apparently, Europe has been afflicted by outbreaks of a 'dancing plague' in the past."

translate Turkish mas_fun_fact_dancing_plague_58136a4b:
...
translate Turkish mas_fun_fact_dancing_plague_0f2a30b8:
...
translate Turkish mas_fun_fact_arrhichion_f867828e:

    m 3eua "Instead of yielding, Arrhichion still aimed for the win by dislocating his opponent's toe."

translate Turkish mas_fun_fact_arrhichion_02e589c7:
...
translate Turkish mas_fun_fact_coffee_origin_d6d9e64a:

    m 7eksdld "...But when he did so, he was met with disapproval and the coffee beans were thrown into a fire."

translate Turkish mas_fun_fact_coffee_origin_5cdc88a5:
...
translate Turkish mas_fun_fact_coffee_origin_8c115315:

    m 3hub "...And I for one can certainly attest that the love of coffee has remained strong to this day!"

translate Turkish mas_fun_fact_synesthesia_6752314c:

    m 1esa "Okay, this one's pretty interesting..."

translate Turkish mas_fun_fact_synesthesia_db2ab4d3:
...
translate Turkish mas_fun_fact_synesthesia_e3b6a243:

    m 1hua "That's kind of a wordy explanation, ehehe...{w=0.2} Let's find an example!"

translate Turkish mas_fun_fact_synesthesia_520901e3:
...
translate Turkish mas_fun_fact_synesthesia_bfecc514:
...
translate Turkish mas_fun_fact_synesthesia_49b34476:

    m "Like, one number appears 'closer' or 'further' away than another number. {w=0.2}{nw}"

translate Turkish mas_fun_fact_synesthesia_4ea888aa:

    extend 3eub "It's kinda like a map!"

translate Turkish mas_fun_fact_synesthesia_80002e89:

    m 1eua "...And there's a whole bunch of other kinds of synesthesia too."

translate Turkish mas_fun_fact_synesthesia_945f3e46:
...
translate Turkish mas_fun_fact_dream_faces_72acca38:

    m 3wud "You don't even have to talk to them in real life!"

translate Turkish mas_fun_fact_dream_faces_c8c110e9:
...
translate Turkish mas_fun_fact_round_earth_a6309de3:

    m 1rsa "Hmm..."

translate Turkish mas_fun_fact_round_earth_6228f0d4:

    m 1eua "[player], do you think the Earth is round or flat?{nw}"

translate Turkish mas_fun_fact_round_earth_b4861dcd:

    m "[player], do you think the Earth is round or flat?{fast}" nointeract

translate Turkish mas_fun_fact_round_earth_17122ba3:

    m 3hua "Right! Pretty much everyone agrees on that nowadays."

translate Turkish mas_fun_fact_round_earth_32f61b70:

    m 3hksdlb "Oh come on, [player]! Are you making fun of me?"

translate Turkish mas_fun_fact_round_earth_5a9ec011:

    m 1eua "Actually, the Earth being round is something that has been known for a pretty long time."

translate Turkish mas_fun_fact_round_earth_fc7a515c:

    m 3esd "Aristotle taught that the Earth was round in the fourth century BC."

translate Turkish mas_fun_fact_round_earth_3dfd6c5a:
...
translate Turkish mas_fun_fact_round_earth_2dd18362:
...
translate Turkish mas_fun_fact_round_earth_a45c98e3:

    m 7rksdla "But Earth being the center of the universe?{w=0.2} {nw}"

translate Turkish mas_fun_fact_round_earth_710aef0a:

    extend 4hksdlb "Oh man!"

translate Turkish mas_fun_fact_round_earth_18e12b3f:

    m 7dsd "People fought about that so hard and for so long, it became a matter of life and death."

translate Turkish mas_fun_fact_round_earth_8369785a:
...
translate Turkish mas_fun_fact_round_earth_256cfb21:

    extend 1esc "He was placed under house arrest for the rest of his life."

translate Turkish mas_fun_fact_round_earth_09b9142c:
...
translate Turkish mas_fun_fact_round_earth_fff48a31:
